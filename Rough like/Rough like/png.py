...
for a in range(1):
    ...
    poison0=pygame.image.load('png/poison0.png')
    poison1=pygame.image.load('png/poison1.png')
    poison2=pygame.image.load('png/poison2.png')
    poison3=pygame.image.load('png/poison3.png')
    poison4=pygame.image.load('png/poison4.png')
    ...
    Rpoison0 = pygame.transform.scale(poison0, (180, 150))
    Rpoison1 = pygame.transform.scale(poison1, (180, 150))
    Rpoison2 = pygame.transform.scale(poison2, (180, 150))
    Rpoison3 = pygame.transform.scale(poison3, (180, 150))
    Rpoison4 = pygame.transform.scale(poison4, (180, 150))

    Lpoison0 = pygame.transform.flip(Rpoison0, True,False)
    Lpoison1 = pygame.transform.flip(Rpoison1, True,False)
    Lpoison2 = pygame.transform.flip(Rpoison2, True,False)
    Lpoison3 = pygame.transform.flip(Rpoison3, True,False)
    Lpoison4 = pygame.transform.flip(Rpoison4, True,False)

    dual0=pygame.image.load('png/dual0.png')
    dual1=pygame.image.load('png/dual1.png')
    dual2=pygame.image.load('png/dual2.png')
    dual3=pygame.image.load('png/dual3.png')
    dual4=pygame.image.load('png/dual4.png')

    Rdual0 = pygame.transform.scale(dual0, (180, 150))
    Rdual1 = pygame.transform.scale(dual1, (180, 150))
    Rdual2 = pygame.transform.scale(dual2, (180, 150))
    Rdual3 = pygame.transform.scale(dual3, (180, 150))
    Rdual4 = pygame.transform.scale(dual4, (180, 150))

    Ldual0 = pygame.transform.flip(Rdual0, True,False)
    Ldual1 = pygame.transform.flip(Rdual1, True,False)
    Ldual2 = pygame.transform.flip(Rdual2, True,False)
    Ldual3 = pygame.transform.flip(Rdual3, True,False)
    Ldual4 = pygame.transform.flip(Rdual4, True,False)
    ...
    papa=pygame.image.load('png/WALLPAPER.png')
    ...
    Leb0=pygame.transform.scale(eb0,(200,160))
    Leb1=pygame.transform.scale(eb1,(200,160))
    Leb2=pygame.transform.scale(eb2,(200,160))
    Leb3=pygame.transform.scale(eb3,(200,160))

    Reb0 = pygame.transform.flip(Leb0, True,False)
    Reb1 = pygame.transform.flip(Leb1, True,False)
    Reb2 = pygame.transform.flip(Leb2, True,False)
    Reb3 = pygame.transform.flip(Leb3, True,False)
