...
roll4=pygame.image.load('roll4.png')
roll5=pygame.image.load('roll5.png')
roll6=pygame.image.load('roll6.png')
...
Rattack0 = pygame.transform.scale(attack0, (180, 120))
Rattack1 = pygame.transform.scale(attack1, (180, 120))
Rattack2 = pygame.transform.scale(attack2, (180, 120))
...
Rroll0 = pygame.transform.scale(roll0, (180, 120))
Rroll1 = pygame.transform.scale(roll1, (180, 120))
Rroll2 = pygame.transform.scale(roll2, (180, 120))
Rroll3 = pygame.transform.scale(roll3, (180, 120))
Rroll4 = pygame.transform.scale(roll4, (180, 120))
Rroll5 = pygame.transform.scale(roll5, (180, 120))
Rroll6 = pygame.transform.scale(roll6, (180, 120))
...
def game():
    ...
    while not crashed:
            ...
            for man in char:
                if event.type==pygame.KEYDOWN:#if key is pressed
                    ...
                    if event.key==pygame.K_w and man.y>460:
                        man.dy=5
                        img=idle0
                    if event.key==pygame.K_k and man.roll==0:
                        if man.right==1:
                            img=Rattack0
                        elif man.left==1:
                            img=Lattack0
        ...
        for man in char:                
            ...
            if man.aa==1 or man.roll==1:
                wn.blit(img,(man.x,man.y+15)) #displays
            else:
